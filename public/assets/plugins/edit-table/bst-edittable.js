...
class BSTable {
    ...
    constructor(tableId, options) {
        ...
        var defaults = {
            ...
            //     columnLabel: 'AKSI',
            //     buttonHTML: `<div class="btn-group text-center">
            //     <button id="bEdit" type="button" class="btn btn-sm btn-primary mx-1">
            //         <span class="fe fe-edit" > </span>
            //     </button>
            //     <button id="bDel" type="button" class="btn  btn-sm btn-danger mx-1">
            //         <span class="fe fe-trash-2" > </span>
            //     </button>
            //     <button id="bAcep" type="button" class="btn  btn-sm btn-warning mx-1" >
