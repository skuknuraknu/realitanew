...
// Disarankan ngoding sambil mendengar lagu watashi psikopat ~ 🎵Unravel ♫
	$(document).ready(function() {
		...
		$(document).on('click', "#btn_addRow", function(e){
			...
			const barisBaru = () => {
    		let data ='<tr> <td></td><td class="kd_ikk"></td>  <td class="indikator_kinerja_kegiatan" contenteditable="false"></td> <td class="kk_mendikbud"></td><td class="kk_menkeu"></td><td id="tw_1"></td><td id="tw_2"></td><td id="tw_3"></td><td id="tw_4"></td><td class="jumlah_bobot"></td><td class="bobot"></td><td class="verifikasi_perencanaan">  <div class="row"> <div class="col-md-7 "><span id="status_perencanaan"></span></div><div class="col-md-5"><div class="btn-group mt-2 mb-2"><button type="button" class="px-1 py-1 btn btn-github btn-pill dropdown-toggle" data-bs-toggle="dropdown"> <span class="caret"></span></button><ul class="dropdown-menu" role="menu"><li class="dropdown-plus-title">Pilih<b class="fa fa-angle-up" aria-hidden="true"></b></li><li id="ver_perencanaan"><a href="javascript:void(0)">Approved</a></li><li id="ver_perencanaan"><a href="javascript:void(0)">Not approved</a></li></ul></div></div></div></td><td class="verifikasi_spi">  <div class="row"><div class="col-md-7 "><span id="status_spi"></span></div><div class="col-md-5"><div class="btn-group mt-2 mb-2"><button type="button" class="px-1 py-1 btn btn-github btn-pill dropdown-toggle" data-bs-toggle="dropdown"> <span class="caret"></span></button><ul class="dropdown-menu" role="menu"><li class="dropdown-plus-title">Pilih<b class="fa fa-angle-up" aria-hidden="true"></b></li><li id="ver_spi"><a href="javascript:void(0)">Approved</a></li><li id="ver_spi"><a href="javascript:void(0)">Not approved</a></li></ul></div></div></div></td></td><td><div class="btn-group"><span class="del_btn"><i role="button" class="bg-danger px-2 mx-1 py-2 fa-solid fe fe-trash-2"></i></span><span class="save_btn"><i role="button" class="bg-info px-2 mx-1 py-2 fa-solid fe fe-check-circle"></i></span><span class="new_btn"><i role="button" class="bg-success px-2 mx-1 py-2 fa-solid fe fe-copy"></i></span><span class="add_btn"><i role="button" class="bg-warning px-2 mx-1 py-2 fa-solid fe fe-plus"></i></span> </div></td></tr>';
    			return data;
			};
